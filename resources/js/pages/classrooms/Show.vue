                    ...
                    >
                        ...
                        <div class="space-y-8 p-6 md:p-8">
                            ...
                            >
                                ...
                                <div
                                    v-if="
                                        activeObject.object.max_attempts !==
                                            null &&
                                        activeQuizSubmissions.length >=
                                            activeObject.object.max_attempts
                                    "
                                    class="flex items-center gap-2 rounded-xl border border-rose-100 bg-rose-50 p-3.5 dark:border-rose-900/50 dark:bg-rose-950/30"
                                >
                                    <span
                                        class="text-xs font-semibold text-rose-800 dark:text-rose-300"
                                    >
                                        Batas maksimum percobaan tercapai (Maks:
                                        {{ activeObject.object.max_attempts }}).
                                    </span>
                                </div>
